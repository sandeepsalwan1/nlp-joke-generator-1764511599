...
#ifndef GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2fgpu_5fblas_5flt_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2fgpu_5fblas_5flt_2eproto_2epb_2eh
...
PROTOBUF_EXPORT extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_xla_2fstream_5fexecutor_2fgpu_2fgpu_5fblas_5flt_2eproto;
namespace xla {
...
constexpr GemmConfigProto_MatrixLayout_Order GemmConfigProto_MatrixLayout_Order_Order_MIN = static_cast<GemmConfigProto_MatrixLayout_Order>(0);
constexpr GemmConfigProto_MatrixLayout_Order GemmConfigProto_MatrixLayout_Order_Order_MAX = static_cast<GemmConfigProto_MatrixLayout_Order>(2);
constexpr int GemmConfigProto_MatrixLayout_Order_Order_ARRAYSIZE = 2 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
GemmConfigProto_MatrixLayout_Order_descriptor();
template <typename T>
...
inline const std::string& GemmConfigProto_MatrixLayout_Order_Name(GemmConfigProto_MatrixLayout_Order value) {
  return ::google::protobuf::internal::NameOfDenseEnum<GemmConfigProto_MatrixLayout_Order_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool GemmConfigProto_MatrixLayout_Order_Parse(absl::string_view name, GemmConfigProto_MatrixLayout_Order* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GemmConfigProto_MatrixLayout_Order>(
...
/* @@protoc_insertion_point(class_definition:xla.GemmConfigProto.MatrixLayout) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GemmConfigProto_MatrixLayout(
  ...
  GemmConfigProto_MatrixLayout* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  explicit GemmConfigProto_MatrixLayout(::google::protobuf::Arena* arena);
  GemmConfigProto_MatrixLayout(::google::protobuf::Arena* arena, const GemmConfigProto_MatrixLayout& from);
  GemmConfigProto_MatrixLayout(::google::protobuf::Arena* arena, GemmConfigProto_MatrixLayout&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:xla.GemmConfigProto) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR GemmConfigProto(
      ::google::protobuf::internal::ConstantInitialized);
  ...
  GemmConfigProto* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  explicit GemmConfigProto(::google::protobuf::Arena* arena);
  GemmConfigProto(::google::protobuf::Arena* arena, const GemmConfigProto& from);
  GemmConfigProto(::google::protobuf::Arena* arena, GemmConfigProto&& from) noexcept
 ...
 public:
  ...
  void set_allocated_lhs_layout(::xla::GemmConfigProto_MatrixLayout* value);
  void unsafe_arena_set_allocated_lhs_layout(::xla::GemmConfigProto_MatrixLayout* value);
  ...
  void set_allocated_rhs_layout(::xla::GemmConfigProto_MatrixLayout* value);
  void unsafe_arena_set_allocated_rhs_layout(::xla::GemmConfigProto_MatrixLayout* value);
  ...
  void set_allocated_c_layout(::xla::GemmConfigProto_MatrixLayout* value);
  void unsafe_arena_set_allocated_c_layout(::xla::GemmConfigProto_MatrixLayout* value);
  ...
  void set_allocated_output_layout(::xla::GemmConfigProto_MatrixLayout* value);
  void unsafe_arena_set_allocated_output_layout(::xla::GemmConfigProto_MatrixLayout* value);
...
inline void GemmConfigProto::unsafe_arena_set_allocated_lhs_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::xla::GemmConfigProto_MatrixLayout* GemmConfigProto::mutable_lhs_layout() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline void GemmConfigProto::set_allocated_lhs_layout(::xla::GemmConfigProto_MatrixLayout* value) {
...
inline void GemmConfigProto::unsafe_arena_set_allocated_rhs_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::xla::GemmConfigProto_MatrixLayout* GemmConfigProto::mutable_rhs_layout() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000002u;
...
inline void GemmConfigProto::set_allocated_rhs_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
...
inline void GemmConfigProto::unsafe_arena_set_allocated_c_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::xla::GemmConfigProto_MatrixLayout* GemmConfigProto::mutable_c_layout() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000004u;
...
inline void GemmConfigProto::set_allocated_c_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
...
inline void GemmConfigProto::unsafe_arena_set_allocated_output_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::xla::GemmConfigProto_MatrixLayout* GemmConfigProto::mutable_output_layout() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000008u;
...
inline void GemmConfigProto::set_allocated_output_layout(::xla::GemmConfigProto_MatrixLayout* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_xla_2fstream_5fexecutor_2fgpu_2fgpu_5fblas_5flt_2eproto_2epb_2eh
